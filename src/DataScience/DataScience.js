          ...
          >
            <div className="p-10 pb-10 mt-12 w-11/12 bg-black rounded-xl flex ">
              ...
              <div className="w-4/5 bg-black flex flex-col items-center">
                <img className="p-12" src="assets/images/asset 50.svg" alt="" />
                ...
                <div className="flex p-6 ">
                  ...
                  <p className="text-white text-lg">
                    ...
                    Benefit from a carefully curated batches, ensuring a collaborative and enriching learning experience.
                  </p>
                </div>
                {/*3 */}
                <div className="flex p-6 ">
