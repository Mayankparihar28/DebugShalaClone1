      ...
      <div className="h-screen flex  justify-center items-center bg-[#030a21]">
        <div className="h-96 w-1/2 flex flex-col justify-center items-center gap-6">
          ...
          <div className="">
            <Link
              to="#_"
              class="animate-pulse relative inline-flex items-center justify-start px-14 py-6 overflow-hidden font-medium transition-all bg-white rounded hover:bg-white group"
            >
        ...
        <div className="w-1/2 flex justify-center items-center">
          ...
          <div className="w-[70%] flex flex-col gap-6">
            ...
            <div className="">
              <Link
                to="#_"
                class="animate-pulse relative inline-flex items-center justify-start px-8 py-4 overflow-hidden font-medium transition-all bg-white rounded hover:bg-white group"
              >
                <span class="w-48 h-48 rounded rotate-[-40deg] bg-purple-600 absolute bottom-0 left-0 -translate-x-full ease-out duration-500 transition-all translate-y-full mb-9 ml-9 group-hover:ml-0 group-hover:mb-32 group-hover:translate-x-0"></span>
                <span class="relative w-full text-left text-black transition-colors duration-300 ease-in-out group-hover:text-white">
                  Lets Talk
