          ...
          >
            <div className="p-5 pb-10 sm:p-10 sm:pb-10 mt-12 w-full sm:w-11/12 bg-black rounded-xl flex flex-col sm:flex-row">
              ...
              <div className="w-full sm:w-1/2 bg-black flex flex-col items-center">
                <img className="p-5 sm:p-12" src="assets/images/asset 50.svg" alt="" />
                ...
                <div className="flex p-5 sm:p-6">
                  ...
                  <p className="text-white text-lg">
                    ...
                    Immerse yourself in hands-on, offline learning, mastering
                    Data Science in a conducive environment.
                  </p>
                </div>
                {/*2 */}
                <div className="flex p-5 sm:p-6">
                  ...
                  <p className="text-white text-lg">
                    ...
                    Benefit from carefully curated batches, ensuring a collaborative and enriching learning experience.
                  </p>
                </div>
                {/*3 */}
                <div className="flex p-5 sm:p-6">
                  ...
                  <p className="text-white text-lg">
                    ...
                    Navigate your Data Science journey with Yukti, your personal AI assistant at DebugShala.
                  </p>
                </div>
                {/*4 */}
                <div className="flex p-5 sm:p-6">
